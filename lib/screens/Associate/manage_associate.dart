...
class Manage_Associate extends StatefulWidget {
  const Manage_Associate({Key key}) : super(key: key);

  @override
  State<Manage_Associate> createState() => _Manage_AssociateState();
}

class _Manage_AssociateState extends State<Manage_Associate> {

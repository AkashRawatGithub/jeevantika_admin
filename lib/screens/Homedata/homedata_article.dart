...
class HomedataArticle extends StatefulWidget {
  const HomedataArticle({Key key}) : super(key: key);

  @override
  State<HomedataArticle> createState() => _HomedataArticleState();
}
class MyData {
  final int id;
  final String name;
...
class _HomedataArticleState extends State<HomedataArticle> {
                ...
                child: Row(
                  children: [
                    Padding(
                      ...
                      child: Text("Artical", style: TextStyle(fontSize: 20,color: Colors.green),),
                    ),
                    SizedBox(width: MediaQuery.of(context).size.width*0.75,),
                    videofrm_? Container(
                      color: Colors.green,
                      child: TextButton(
                        child: const Text('Articals List',style: TextStyle(color: Colors.white),),
                        onPressed: () {setState(() {
                          videofrm_=! videofrm_;
                        });
                        },
                                ...
                                Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: DropdownButton<String>(
                                      ...
                                      isExpanded: true,
                                      value: _selected,
                                      hint: Text('Choose Type',style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold),),
                                      items: _Values.map((item) {
                                        return DropdownMenuItem(
                                          child: new Text(item),
                                          value: item,

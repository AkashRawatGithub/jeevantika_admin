...
class HomeDataWeblink extends StatefulWidget {
  const HomeDataWeblink({Key key}) : super(key: key);

  @override
  State<HomeDataWeblink> createState() => _HomeDataWeblinkState();
}
class MyData {
  final int id;
  final String name;
...
class _HomeDataWeblinkState extends State<HomeDataWeblink> {
                ...
                child: Row(
                  children: [
                    Padding(
                      ...
                      child: Text("Weblink", style: TextStyle(fontSize: 20,color: Colors.green),),
                    ),

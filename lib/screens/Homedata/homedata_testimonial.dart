...
class HomeDataTestimonial extends StatefulWidget {
  const HomeDataTestimonial({Key key}) : super(key: key);

  @override
  State<HomeDataTestimonial> createState() => _HomeDataTestimonialState();
}
class MyData {
  final int id;
  final String name;
...
class _HomeDataTestimonialState extends State<HomeDataTestimonial> {
                        ...
                        child: Row(
                          children: [
                            Padding(
                              ...
                              child: Text("Testimonial", style: TextStyle(fontSize: 20,color: Colors.green),),
                            ),

...
class Add_Manager extends StatefulWidget {
  Add_Manager({Key key,  this.dropdown}) : super(key: key);
  String dropdown;
                      ...
                      Padding(
                        ...
                        child: Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(5),color: Colors.white,),
                          ...
                          child: const Padding(
                            ...
                            child: Text("Add Manager", style: TextStyle(fontSize: 24,color: Colors.green),),
                          ),
                        ),
                      ),
                      Padding(
                                        ...
                                        Container(
                                          ...
                                          child: Padding(
                                            ...
                                            child: DropdownButton<String>(
                                              ...
                                              hint: Text('Select Profession',style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold),),
                                              items: _Values.map((item) {
                                                return DropdownMenuItem(
                                                  child: new Text(item),
                                                  value: item,

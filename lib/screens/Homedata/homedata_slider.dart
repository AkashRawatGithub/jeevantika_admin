...
class HomeDataSlider extends StatefulWidget {
  const HomeDataSlider({Key key}) : super(key: key);

  @override
  State<HomeDataSlider> createState() => _HomeDataSliderState();
}
class MyData {
  final int id;
  final String name;
...
class _HomeDataSliderState extends State<HomeDataSlider> {
                ...
                child: Row(
                  children: [
                    Padding(
                      ...
                      child: Text("Slider", style: TextStyle(fontSize: 20,color: Colors.green),),
                    ),

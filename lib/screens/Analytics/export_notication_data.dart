...
class Export_Notificationdata extends StatefulWidget {
  const Export_Notificationdata({Key key}) : super(key: key);

  @override
  State<Export_Notificationdata> createState() => _Export_NotificationdataState();
}

class _Export_NotificationdataState extends State<Export_Notificationdata> {
                                  ...
                                  child: Column(mainAxisAlignment: MainAxisAlignment.start,crossAxisAlignment: CrossAxisAlignment.start ,
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: custom_button_2(export_1,Colors.blue.shade500,"Export Search & Fav. Notification"),
                                      ),

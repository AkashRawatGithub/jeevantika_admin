...
class CompletedCustomers extends StatefulWidget {
  const CompletedCustomers({Key key}) : super(key: key);

  @override
  State<CompletedCustomers> createState() => _CompletedCustomersState();
}
List<String> _Values = [];
var _selected;
List<String> item = [
...
class _CompletedCustomersState extends State<CompletedCustomers> {

...
class HomeDataInformation extends StatefulWidget {
  const HomeDataInformation({Key key}) : super(key: key);

  @override
  State<HomeDataInformation> createState() => _HomeDataInformationState();
}
class MyData {
  final int id;
  final String name;
...
class _HomeDataInformationState extends State<HomeDataInformation> {
                        ...
                        child: Row(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Text("Information", style: TextStyle(fontSize: 20,color: Colors.green),),
                            ),
                            videofrm_? Container(
                              color: Colors.green,
                              child: TextButton(
